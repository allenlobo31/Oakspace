        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white space-y-6 -mt-40 lg:mt-0 md:-mt-60">
         <div className="lg:-mt-8">
          ...
          <div className='flex flex-row gap-4 justify-center items-center'>
            <button className="mt-4 px-6 py-4 w-[175px] bg-white/20 hover:bg-white/30 text-white border border-white/50 backdrop-blur-sm transition-all duration-300 text-lg font-semibold hover:scale-105 rounded-xl flex items-center justify-center">
              Explore Collection
            </button>
            <button className="mt-4 px-6 py-4 w-[175px] bg-white/20 hover:bg-white/30 text-white border border-white/50 backdrop-blur-sm transition-all duration-300 text-lg font-semibold hover:scale-105 rounded-xl flex items-center justify-center">
              Best Sellers
